...
// Gets current user internally — no userId prop needed.
    ...
    <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
        ...
        <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-[#F0F0F4]">
          <h2 className="text-sm font-semibold text-[#0F0F12]">
            {selected ? 'Confirm assignment' : 'Assign to Mandate'}
          </h2>
        ...
        {!selected ? (
          /* ── Step 1: filter by client, pick mandate ── */
